...
public class MapperConstants {
    ...
    public static final String OUTPUT_TOPIC_ARN = "OUTPUT_TOPIC_ARN";
    public static final String TENANT_OUTPUT_TABLE = "tenant-output";
    public static final String MAPPING_DONE_QUEUE = "mapping_done_queue_url";
