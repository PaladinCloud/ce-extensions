...
import (
	...
	"svc-asset-opinions-layer/extension"
	"svc-asset-opinions-layer/server"
...
func startMain(configuration *clients.Configuration) error {
	...
	assetOpinionsClient, err := clients.NewAssetOpinionsClient(ctx, configuration)
	if err != nil {
		return err
	}
	...
	httpServerClient = &server.HttpServer{
		...
		AssetOpinionsClient: assetOpinionsClient,
	}
